...
import { Building2, Mail, Loader2, ArrowLeft, CheckCircle2, Lock } from 'lucide-react';
...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="min-h-screen flex relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800">
      ...
      {/* Left side - LCMS branding (identical to login) */}
            ...
            <CardContent className="px-8 pb-8">
              {submitted ? (
                <div className="space-y-6 animate-fade-in-up">
                  ...
                  <Button
                    type="button"
                    className="w-full h-14 text-lg font-semibold bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105"
                  ...
                  <div className="text-center">
                    <Link
                      to="/login"
                      className="text-sm text-blue-600 hover:text-blue-800 transition-colors duration-300 inline-flex items-center gap-1 underline decoration-blue-300 underline-offset-4"
                    >
                  ...
                  <div className="space-y-3 animate-fade-in-up" style={{animationDelay: '0.6s'}}>
                    ...
                    <div className="relative group">
                      <Input
                        ...
                        className="h-14 text-base border-2 w-full px-4 bg-white/90 backdrop-blur-sm transition-all duration-300 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 focus:shadow-lg placeholder:text-gray-400 group-hover:border-blue-300 border-gray-200"
                        disabled={isLoading}
                        autoFocus
                      />
                    ...
                    {error && (
                      <p className="text-sm text-red-600 flex items-center gap-2 mt-1 animate-shake">
